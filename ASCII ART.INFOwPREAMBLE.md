...
Several years ago I tried to inform some of what I had learned about or of some simple techniques to create the graphics which are sometimes part of the README which comes with some dev:admin cli tools that are included in a README. While telling the story I couldn’t recall the official term but had referenced back to when I was even younger during the elementary school years when I had first came across it. That happened either in 1984 or 1985 while in computer classes when I learned a few fundamentals about software and what it is to the machine using it.
